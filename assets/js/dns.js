...
const dsnGrid = {
  ...
  convertTextLine: function (e, t = "chars", n = !1) {
    return (
      ...
      !n &&
        e.find(".whitespace").length &&
        (e.find(".whitespace").get(0).outerHTML = " "),
          ...
          !0 === n._fixed &&
            ...
            $effectScroll.getListener(function () {
              r &&
                i.css(
                  "transform",
                  "translateY(" + $effectScroll.getScrollbar().offset.y + "px)"
                );
            }, !1)),
          !0 === n.refreshParallax &&
            !0 === n.reverse &&
  ...
  mouseMove: function (e, t) {
    ...
    $body.on("mousemove", function (i) {
      gsap.to(e, t.speed || 0.5, { left: i.clientX, top: i.clientY }),
        void 0 !== t &&
          void 0 !== t.onUpdate &&
          t.onUpdate(i, i.pageX, i.pageY, e),
        void 0 !== t &&
          void 0 !== t.onComplete &&
          ((n = !0),
  ...
  scrollTop: function (e, t, n, i) {
    ...
    "number" == typeof e
      ? (o = e)
      : (e = this.convertToJQuery(e)).length && (o = e.get(0).offsetTop),
      gsap.to(
        window.Scrollbar.get(document.querySelector("#dsn-scrollbar")) || $wind,
        t || 1,
        { scrollTo: { y: o + (n || 0) }, onComplete: i }
      ),
      (o = t = e = null);
  },
    ...
    r.append(a),
      ...
      r
        ...
        .on("mousemove", function (e) {
          dsnGrid.parallaxIt(e, s, t, n),
            dsnGrid.parallaxIt(e, a, 2 * t, n),
            void 0 !== i && dsnGrid.parallaxIt(e, i, -5, 0.5);
        });
  },
        ...
        new (function (e, t, n) {
          ...
          function f(e = 0, t) {
            ...
            (this.width = o.offsetWidth),
              ...
              (this.imageAspect =
                !0 === t
                  ? s[e].image.height / s[e].image.width
                  : this.mat.uniforms.texture.value.image.height /
                    this.mat.uniforms.texture.value.image.width),
              this.height / this.width > this.imageAspect
                ? ((n = (this.width / this.height) * this.imageAspect), (i = 1))
                : ((n = 1), (i = this.height / this.width / this.imageAspect));
          ...
          function v(e, t) {
            (d = !0),
              void 0 !== n.onStart && n.onStart.bind(this, e, t)(),
              f.bind(this)(e, !0);
          }
          function m() {
          ...
          function g() {
            (this.mat.uniforms.texture.value = s[u]),
              (this.mat.uniforms.dispFactor.value = 0),
              (d = !1),
              void 0 !== n.onEnd && n.onEnd.bind(this)();
          }
          $(o).addClass("three-js-loader"),
            ...
            (async function () {
              ...
              .then(() => {
                (this.loader = new THREE.TextureLoader(this.manager)),
                  ((i = this.loader.load(r)).wrapS = i.wrapT =
              ...
              .then(() => {
                (this.animate = function () {
                  ...
                  (this.manager.onLoad = function () {
                    $(o).removeClass("three-js-loader"),
                      !0,
                      f.bind(a, 0)(),
                      window.addEventListener("resize", f.bind(a, 0));
                  });
              })
              .then(() => {
                l.length &&
            ...
            (this.prev = function () {
              void 0 === this.renderer ||
                ...
                (h = u),
                (u = 0 === u ? s.length - 1 : Math.abs((u - 1) % s.length)),
                this.changeTo(u));
            }),
    ...
    return (
      ...
      e
        ...
        .on("mousemove", function (i) {
          if (
            void 0 !== n.dataActive &&
            jQuery(this).find(e).hasClass(n.dataActive)
          )
            return !1;
  ...
  scaleIt: function (e, t, n) {
    ...
    var i,
      ...
      r,
      s = 0;
    (s = body.hasClass("dsn-effect-scroll")
      ? window.$wind.scrollTop
      : window.$wind.scrollTop()),
      (r = this.getUndefinedVal(n.plus, 0)),
      (i = this.getUndefinedVal(n.position, !1));
    var a = t.offset();
    return (
      (o = void 0 === a || body.hasClass("dsn-effect-scroll") ? 0 : a.top),
      i && (o -= s),
      s / (t.height() + o + r)
    );
  },
  scrollerIt: function (e, t, n) {
    ...
    (r = this.getUndefinedVal(n.duration, 0)),
      (o = this.getUndefinedVal(n.plus, 0));
    var a = t.offset();
      ...
      if (i[r].length > 0) {
        if (((o += '<span class="dsn-wrapper">'), n)) {
          ...
          for (var s = 0; s < i[r].length; s++)
            o +=
              '<span class="dsn-chars-wrapper">' + i[r].charAt(s) + "</span>";
          o += "</span>";
      ...
      r
        .on("mouseleave", function (e) {
          TweenMax.to(r, n, { scale: 1 }),
            TweenMax.to(l, 0.3, { scale: 1, x: 0, y: 0 }),
            TweenMax.to(d, n, { scale: 1, x: 0, y: 0 });
        })
        .on("mouseenter", function (e) {
          TweenMax.to(r, n, { transformOrigin: "0 0", scale: 1 }),
            TweenMax.to(d, n, { scale: 1.2 });
        })
        .on("mousemove", function (e) {
  ...
  changeSizeText: function (e, t) {
    e instanceof jQuery == !1 && (e = jQuery(e)),
      e.each(function () {
        var e = jQuery(this);
        for (var n in t)
          e.text().length >= parseInt(n) && (console.log(t[n]), e.css(t[n]));
      });
  },
  animateText: function (e, t, n, i) {
    ...
    function r() {
      t.each(function () {
        ...
        let t = e.offset().top;
        void 0 !== t &&
          o > t - (window.$wind.height() - 100) &&
          (e.hasClass("dsn-animate") || e.addClass("dsn-animate"));
      });
    }
    var s = null;
    _window.$wind.getListener(function (e) {
      (o = void 0 === e.offset ? window.$wind.scrollTop() : 0),
        s && clearTimeout(s),
        (s = setTimeout(r, 10));
    });
  },
  ...
  progressCircle: function (e) {
    ...
    e.isScroller(!0) && (o = e.getScrollbar()),
      e.getListener(function (e) {
        ...
        void 0 === e.offset
          ? (n = window.$wind.scrollTop())
          : ((n = e.offset.y),
            (i = $(document).height() - o.getSize().content.height + 100)),
          n > 70
            ? (TweenMax.to(t, 1, { ease: Back.easeOut.config(4), right: 60 }),
              t
                .find(".dsn-progress-path")
                .css(
                  "stroke-dashoffset",
                  300 - Math.round((300 * n) / i) + "%"
                ))
